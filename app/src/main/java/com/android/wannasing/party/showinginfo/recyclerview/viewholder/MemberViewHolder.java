package com.android.wannasing.party.showinginfo.recyclerview.viewholder;
...
import com.android.wannasing.databinding.ItemMemberInShowingPartyInfoBinding;
...
public class MemberViewHolder extends RecyclerView.ViewHolder {
  ...
  private ItemMemberInShowingPartyInfoBinding binding;

  public MemberViewHolder(ItemMemberInShowingPartyInfoBinding binding,
  ...
  public static MemberViewHolder create(@NonNull ViewGroup parent,
    ...
    return new MemberViewHolder(
        ItemMemberInShowingPartyInfoBinding.inflate(
