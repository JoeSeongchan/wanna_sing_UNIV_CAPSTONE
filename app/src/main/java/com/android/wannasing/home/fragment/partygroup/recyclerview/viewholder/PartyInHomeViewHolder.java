package com.android.wannasing.home.fragment.partygroup.recyclerview.viewholder;
...
import com.android.wannasing.databinding.ItemPartyInHomeBinding;
import com.android.wannasing.db.entity.Party;
import java.time.LocalTime;
import java.util.Calendar;
import java.util.EventListener;

public class PartyInHomeViewHolder extends RecyclerView.ViewHolder {

  private Party party;

  private ItemPartyInHomeBinding binding;

  public PartyInHomeViewHolder(ItemPartyInHomeBinding binding,
  ...
  @NonNull
  public static PartyInHomeViewHolder create(@NonNull ViewGroup parent,
      OnPartyItemClickListener onPartyItemClickListener) {
    return new PartyInHomeViewHolder(
        ItemPartyInHomeBinding.inflate(
