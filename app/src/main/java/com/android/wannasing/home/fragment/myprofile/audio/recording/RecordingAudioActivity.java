package com.android.wannasing.home.fragment.myprofile.audio.recording;
    ...
    record.setOnClickListener(view -> {
      if (isRecording == false) {
        ...
        record.setImageDrawable(
            ResourcesCompat
                .getDrawable(getResources(), R.drawable.showing_my_profile_btn_stop_icon, null));
        ...
        record.setImageDrawable(
            ResourcesCompat
                .getDrawable(getResources(), R.drawable.recording_audio_btn_record_icon, null));
