package com.android.wannasing.home.fragment.map.api;
...
import com.android.wannasing.party.creating.CreatingGroupActivity;
...
public class DetailInfo extends DialogFragment {
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    View view = getActivity().getLayoutInflater()
        .inflate(R.layout.fragment_showing_karaoke_info, null);
