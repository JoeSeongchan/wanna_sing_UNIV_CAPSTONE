...
public class GetNewProfileActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_get_new_profile);

    editText = findViewById(R.id.getNewProfile_et_input);
    Intent intent = getIntent();
    titlechange = intent.getStringExtra("option");
    title = findViewById(R.id.getNewProfile_tv_title);
