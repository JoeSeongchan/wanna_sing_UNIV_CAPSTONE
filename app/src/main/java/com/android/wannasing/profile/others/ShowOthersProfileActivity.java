package com.android.wannasing.profile.others;
...
public class ShowOthersProfileActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_showing_others_profile);
    init();
  ...
  private void init() {
    ...
    // 리사이클러뷰
    RecyclerView audioRecyclerView = findViewById(R.id.showingMyProfile_rv_songList);
