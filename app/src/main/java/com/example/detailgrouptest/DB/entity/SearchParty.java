...
public class SearchParty {
  ...
  public SearchParty(String partyName,
      List<com.example.detailgrouptest.DB.entity.SearchParty.Genre> genreList,
      com.example.detailgrouptest.DB.entity.SearchParty.Gender gender, int age,
      List<com.example.detailgrouptest.DB.entity.SearchParty.AgeDetail> ageDetailList) {
